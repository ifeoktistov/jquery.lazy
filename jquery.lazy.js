 ...
 *
 *
 * fiexd by Feoktistov Igor v0.1.11
 *
 * jQuery Lazy - v0.1.10
    ...
    $.fn.lazy = function(settings)
    {
        ...
        function _init()
        {
            ...
            if( configuration.delay < 0 || configuration.combined )
            {
                ...
                if (configuration.addScrollContainer) {
                    configuration.addScrollContainer.bind("scroll", _throttle(configuration.throttle, lazyLoadImages));
                }
